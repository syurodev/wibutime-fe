...
import { NAVIATION_HEADER_MENU_VN_LANG } from "@/international/vietnamese/navigation-header-menu";
    ...
    <NavigationMenu>
      <NavigationMenuList>
        <NavigationMenuItem>
          ...
          <NavigationMenuContent>
            <ul className="grid gap-3 p-6 w-[400px] lg:w-[500px] lg:grid-cols-[.75fr_1fr] bg-background/50">
        ...
        <NavigationMenuItem>
          ...
          <NavigationMenuContent>
            <ul className="grid w-[400px] gap-3 p-4 md:w-[500px] md:grid-cols-2 lg:w-[600px] ">
              {NAVIATION_HEADER_MENU_VN_LANG.LIGHTNOVEL.map((component) => (
                <ListItem
                  key={component.title}
                  title={component.title}
                  href={component.href}
